...
var rodarCutsceneInicio = true #Verifica se é a primeira vez entrando no primeiro mundo, para rodar ou não a cutscene
var rodarCutsceneLume = true #Verifica se é a primeira vez entrando no segundo mundo, para rodar ou não a cutscene
