...
# Criação das variáveis geradas no começo da cena contendo o espaço das instruções que o jogador irá gerar.
...
var guardaValor = 0 # Guarda momentâneamente o valor das contas e, ao final, jogar para o valorReal.
